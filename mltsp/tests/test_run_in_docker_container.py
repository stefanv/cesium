...
def test_featurize_in_docker_container():
    ...
    os.remove(pjoin(cfg.FEATURES_FOLDER, "test_classes.pkl"))
...
def test_build_model_in_docker_container():
    ...
    shutil.copy(pjoin(DATA_PATH, "test_classes.pkl"),
                pjoin(cfg.FEATURES_FOLDER, "TEMP_TEST01_classes.pkl"))
    ...
    os.remove(pjoin(cfg.FEATURES_FOLDER, "TEMP_TEST01_classes.pkl"))
